    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-16">
        ...
        <div className="max-w-2xl mx-auto">
          ...
          I’m Pavan Alapati (aka AngryBird), a third-year undergraduate specializing in Computer Science (Cybersecurity). My research lies in Red Teaming and Threat Hunting, with a focus on Privilege Escalation, Defense Evasion, Credential Access, Lateral Movement, and other offensive security mechanisms.
          </p>
